 ...
 */
@Component
public class MemberValidationFilter extends AbstractGatewayFilterFactory<MemberValidationFilter.Config> {
	 ...
	 */
	public MemberValidationFilter(JwtUtils jwtUtils) {
		super(MemberValidationFilter.Config.class);
